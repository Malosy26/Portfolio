...
def SobreMi():
    ...
    with col2:
        ...
        with colaux1:
            foto_linkdn = Image.open(r"D:\descargas chrome\fotosIconosRedesSociales\linkdncolor1.png")
            st.image(foto_linkdn,width = 50 )
            espacio(1)
            foto_correo = Image.open (r"D:\descargas chrome\fotosIconosRedesSociales\gmail1.png")
            st.image(foto_correo, width = 50 )
            espacio(1)
            foto_gitlab = Image.open (r"D:\descargas chrome\fotosIconosRedesSociales\gitlab1.png")
            st.image(foto_gitlab, width = 50 )
            espacio(1)
            foto_github = Image.open (r"D:\descargas chrome\fotosIconosRedesSociales\github1.png")
    ...
    with col5:
        foto_machine_learning = Image.open(r"D:\descargas chrome\fotos librerias phyton\Beutiful1.png")
        st.image(foto_machine_learning,width = 200)
        espacio(1)
        foto_numpy = Image.open(r"D:\descargas chrome\fotos librerias phyton\numpy.png")
        st.image(foto_numpy,width = 200)
        espacio(1)
        foto_matplotlib = Image.open(r"D:\descargas chrome\fotos librerias phyton\matplotlib1.png")
        st.image(foto_matplotlib,width = 200)
        espacio(1)
        foto_pandas = Image.open(r"D:\descargas chrome\fotos librerias phyton\pandas1.png")
        st.image(foto_pandas,width = 200)
        espacio(1)
        foto_sql = Image.open(r"D:\descargas chrome\fotos librerias phyton\sql1.png")
        st.image(foto_sql,width = 200)
        espacio(1)
        foto_pyspark = Image.open(r"D:\descargas chrome\fotos librerias phyton\pyspark1.png")
        st.image(foto_pyspark,width = 200)
        espacio(1)
        foto_ml = Image.open(r"D:\descargas chrome\fotos librerias phyton\machinelearning.png")
        st.image(foto_ml,width = 200)
        espacio(1)
        foto_tf = Image.open(r"D:\descargas chrome\fotos librerias phyton\tensorflow1.png")
